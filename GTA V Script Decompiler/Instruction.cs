...
namespace Decompiler
{
	...
	internal class Instruction // Might need to check this too.
	{
		...
		public static Opcode MapOpcode(byte opcode) => (Opcode)opcode;
		...
		public int GetOperandsAsInt
		{
			get
			{
				return Operands.Length switch
				{
					...
					_ => 0, // null, seems to work okayish so far.
							// not sure what operands are,
							// or why the length is wrong...
		...
		public ushort SwitchCases => GetOperand(0);
